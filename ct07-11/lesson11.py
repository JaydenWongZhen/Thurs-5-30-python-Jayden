...
cyn.write("Cyn",align="center",font=("Comic Sans MS",20))
jovi.write("Jovi",align="center",font=("Comic Sans MS", 20))
eldrichhoror.write(" jj double hockey sticks",align="center",font=("Comic Sans MS", 20))
p.mainloop()